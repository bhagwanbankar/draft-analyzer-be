...
from civis_backend_policy_analyser.models.document import Document
from civis_backend_policy_analyser.schemas.document_schema import DocumentOut
...
class DocumentView(BaseView):
    ...
    async def upload_policy_document(self, file: UploadFile) -> Document:
        ...
        stmt = select(Document).where(Document.doc_id == file_hash)
